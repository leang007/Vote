...
user_answer_base64 = """Input__capture"""
...
payload = "server_id=20218&captcha="+user_answer_base64+"&gameid=lanks007&checksum="+cut_get_image
print("Data before send : " + payload + "\n") 
headers = {
...
print("Checksum : " + cut_get_image) 
response = requests.request("POST", "http://playserver.co/index.php/Vote/ajax_getpic/-Miss-Ro--จุติ-800-HI-CLASS-เปิด-030263-1700-20218", data=payload, headers=headers)
